...
df_hosa=spark.read.parquet("/Volumes/rcm_dataproject_ws/containers/bronze_container/hosa/transactions")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/Volumes/rcm_dataproject_ws/containers/bronze_container/hosb/transactions")
