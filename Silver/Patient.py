...
df_hosa=spark.read.parquet("/Volumes/rcm_dataproject_ws/containers/bronze_container/hosa/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("/Volumes/rcm_dataproject_ws/containers/bronze_container/hosb/patients")
