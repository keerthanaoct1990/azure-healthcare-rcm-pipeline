...
claims_df=spark.read.csv("/Volumes/rcm_dataproject_ws/containers/landing_container/claims/*.csv",header=True)
...
claims_df.write.format("parquet").mode("overwrite").save("/Volumes/rcm_dataproject_ws/containers/bronze_container/claims/")
