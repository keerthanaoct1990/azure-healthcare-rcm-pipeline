...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/Volumes/rcm_dataproject_ws/containers/bronze_container/hosa/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/Volumes/rcm_dataproject_ws/containers/bronze_container/hos/encounters"
# MAGIC );
# MAGIC
