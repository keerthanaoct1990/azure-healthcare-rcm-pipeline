...
# Read the CSV file
cptcodes_df = spark.read.csv("/Volumes/rcm_dataproject_ws/containers/landing_container/cptcodes/*.csv", header=True)
...
cptcodes_df.write.format("parquet").mode("overwrite").save("/Volumes/rcm_dataproject_ws/containers/bronze_container/cpt_codes")
